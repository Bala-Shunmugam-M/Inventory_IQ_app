...
// ── Reducer helpers (kept small for readability) ──────────────────
...
function useToast() {
  ...
  React.useEffect(() => {
    ...
    // setState from useState is stable (React guarantees).
    // listeners is a module-level constant. No deps needed — mount-only subscription.
  }, [])
