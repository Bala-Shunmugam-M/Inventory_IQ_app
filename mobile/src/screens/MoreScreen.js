...
export default function MoreScreen({ navigation }) {
  ...
  const submitRestore = async () => {
    ...
    const target = restoreDeviceId.trim();
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modal}>
            ...
            <Text style={styles.modalSub}>
              Enter Device ID to pull from, or leave blank to use this device.
            </Text>
            <TextInput
              style={styles.restoreInput}
              value={restoreDeviceId}
              onChangeText={setRestoreDeviceId}
              placeholder={deviceId || 'IQ-XXXXX-XXXXX'}
            ...
            <View style={styles.restoreActions}>
              ...
              <TouchableOpacity style={styles.restoreSubmit} onPress={submitRestore}>
...
const styles = StyleSheet.create({
  ...
  restoreActions: { flexDirection: 'row', gap: 8, marginTop: 14 },
  restoreCancel: {
    flex: 1,
    backgroundColor: COLORS.surface,
    paddingVertical: 11,
  ...
  restoreCancelText: { color: COLORS.ink2, fontWeight: '700', fontSize: 13 },
  restoreSubmit: {
    flex: 1,
    backgroundColor: COLORS.ink,
    paddingVertical: 11,
  ...
  restoreSubmitText: { color: '#fff', fontWeight: '700', fontSize: 13 },
});
